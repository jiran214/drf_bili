    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=30, null=True, verbose_name='性名')),
                ...
                ('image', models.ImageField(blank=True, null=True, upload_to='avatar/%Y/%m', verbose_name='头像')),
                ('vip', models.IntegerField(choices=[(0, '普通用户'), (1, 'vip'), (2, 'svip'), (3, 'sss')], default=0)),
